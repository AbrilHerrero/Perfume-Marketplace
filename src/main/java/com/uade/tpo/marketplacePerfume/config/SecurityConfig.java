    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(HttpMethod.GET, "/payment/me").hasRole("BUYER")
                        .requestMatchers(HttpMethod.GET, "/payment/order/*/status").hasRole("SELLER")
                        .requestMatchers(HttpMethod.POST, "/payment").hasRole("BUYER")
                        .requestMatchers(HttpMethod.PATCH, "/payment/*/status").hasRole("SELLER")
