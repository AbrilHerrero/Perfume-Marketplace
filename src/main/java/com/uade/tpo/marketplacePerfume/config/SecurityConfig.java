...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/perfume/**").hasAnyRole("ADMIN", "SELLER")
                        .requestMatchers(HttpMethod.DELETE, "/perfume/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/sample/mine").hasRole("SELLER")
                        .requestMatchers(HttpMethod.GET, "/sample/admin/**").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/sample/*/active").hasAnyRole("SELLER", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/order/seller-stats").hasRole("SELLER")
                        .requestMatchers(HttpMethod.GET, "/order/seller").hasRole("SELLER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/coupons").hasRole("SELLER")
                        .requestMatchers(HttpMethod.PUT, "/coupons/**").hasRole("SELLER")
                        .requestMatchers(HttpMethod.DELETE, "/coupons/**").hasAnyRole("SELLER", "ADMIN")
    ...
    // Permissive CORS: allows any origin, method, and header so the frontend can
    // call the API cross-origin from any dev host.
    @Bean
